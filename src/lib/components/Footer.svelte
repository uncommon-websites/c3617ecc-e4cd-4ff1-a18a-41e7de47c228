		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
			...
			<div class="lg:col-span-2">
				<div class="flex items-center gap-2 mb-8">
					...
					<span class="text-2xl font-bold tracking-tight">ALPHV</span>
				</div>
                
                <div class="mt-20">
                    <a href="#" class="text-sm font-medium border-b border-white pb-1 hover:opacity-80 transition-opacity inline-block">Join our community</a>
                    <div class="text-[10px] text-gray-500 mt-4">© ALPHV 2025 • Kuala Lumpur, Malaysia</div>
                </div>
			</div>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					<li><a href="#" class="hover:text-white transition-colors">AI Integration</a></li>
					<li><a href="#" class="hover:text-white transition-colors">System Architecture</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Fintech Solutions</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Healthcare AI</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Insurance Tech</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Case Studies</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Implementation</a></li>
			...
			<!-- Column 2 -->
			<div>
				<h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-6">Community</h4>
				<ul class="space-y-3 text-sm text-gray-300">
					<li><a href="#" class="hover:text-white transition-colors">Developer Network</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Events & Meetups</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Tech Talks</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Training Programs</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Talent Pool</a></li>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					...
					<li><a href="#" class="hover:text-white transition-colors">Alibaba Cloud</a></li>
